...
const apiCanaryBlueprint = async function () {
 ...
 const testIntegrityForLayer = async function(datasets, countryISOCodes, layer, operation){
  ...
  /*log.info("----------------------------------------------------------- ")
  if(throwException){
      throw new Error("0 number of alerts returned for the past week across the following countries " + countriesISOCodes + " for the following contextuallayers " + throwExceptionKey);
  }*/
