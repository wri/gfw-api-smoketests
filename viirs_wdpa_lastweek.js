...
const apiCanaryBlueprint = async function () {
 ...
 const getFormattedDate = function(incomingDate) {
  ...
  requestOptions.path = "/v1/query/?sql=select%20sum%28alert__count%29%20as%20sum_alert_count%20from%20" + datasets.VIIRS_WDPA_daily + "%20where%20alert__date%3E%3D%27" + getFormattedDate(lastMonday) + "%27%20and%20alert__date%3C%3D%27" + getFormattedDate(currDate) + "%27";
